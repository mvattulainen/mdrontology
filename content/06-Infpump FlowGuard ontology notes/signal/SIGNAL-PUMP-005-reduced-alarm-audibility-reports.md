---
{
  "id": "SIGNAL-PUMP-005",
  "type": "signal",
  "title": "Reduced alarm audibility reports",
  "aliases": [
    "SIGNAL-PUMP-005",
    "SIGNAL-PUMP-005-reduced-alarm-audibility-reports",
    "18-ontology-notes/signal/SIGNAL-PUMP-005-reduced-alarm-audibility-reports",
    "03-Ontology notes/signal/SIGNAL-PUMP-005-reduced-alarm-audibility-reports"
  ],
  ...
  "technical_file_identifier": "SIGNAL-PUMP-005",
  ...
  "triggers": [
    "[[06-Infpump FlowGuard ontology notes/change/CHG-PUMP-005-alarm-speaker-supplier-change|CHG-PUMP-005]]"
  ]
}
---

# Reduced alarm audibility reports
...
- **type:** `signal`
- **title:** `Reduced alarm audibility reports`
- **aliases:** `SIGNAL-PUMP-005`, `SIGNAL-PUMP-005-reduced-alarm-audibility-reports`, `18-ontology-notes/signal/SIGNAL-PUMP-005-reduced-alarm-audibility-reports`, `03-Ontology notes/signal/SIGNAL-PUMP-005-reduced-alarm-audibility-reports`
- **status:** `under-assessment`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
- **triggers:** [[06-Infpump FlowGuard ontology notes/change/CHG-PUMP-005-alarm-speaker-supplier-change|CHG-PUMP-005]]
...
Succeeding dependencies are ontology notes to which this record leads. The trace continues through `concerns` to [[06-Infpump FlowGuard ontology notes/device-configuration/DEVC-PUMP-005-infpump-flowguard-critical-care-configuration-11|DEVC-PUMP-005 — Infpump FlowGuard critical-care configuration 1.1]]; `triggers` to [[06-Infpump FlowGuard ontology notes/change/CHG-PUMP-005-alarm-speaker-supplier-change|CHG-PUMP-005 — Alarm speaker supplier change]]. These outgoing links identify the next product, risk, control, evidence, change or lifecycle records used by downstream reasoning.

The left-to-right diagram shows up to five asserted previous and five asserted succeeding ontology-note dependencies. When more links exist, the additional-dependency node states how many remain available through the verbal links and structured metadata above.

```mermaid
flowchart LR
  CURRENT["SIGNAL-PUMP-005<br/>Reduced alarm audibility reports"]
  ...
  NEXT1["CHG-PUMP-005<br/>Alarm speaker supplier change"]
