---
{
  "id": "SIGNAL-PUMP-010",
  "type": "signal",
  "title": "Therapy-log timestamp discrepancies",
  "aliases": [
    "SIGNAL-PUMP-010",
    "SIGNAL-PUMP-010-therapy-log-timestamp-discrepancies",
    "18-ontology-notes/signal/SIGNAL-PUMP-010-therapy-log-timestamp-discrepancies",
    "03-Ontology notes/signal/SIGNAL-PUMP-010-therapy-log-timestamp-discrepancies"
  ],
  ...
  "technical_file_identifier": "SIGNAL-PUMP-010",
  ...
  "triggers": [
    "[[06-Infpump FlowGuard ontology notes/change/CHG-PUMP-010-administration-set-compatibility-extension|CHG-PUMP-010]]"
  ]
}
---

# Therapy-log timestamp discrepancies
...
- **type:** `signal`
- **title:** `Therapy-log timestamp discrepancies`
- **aliases:** `SIGNAL-PUMP-010`, `SIGNAL-PUMP-010-therapy-log-timestamp-discrepancies`, `18-ontology-notes/signal/SIGNAL-PUMP-010-therapy-log-timestamp-discrepancies`, `03-Ontology notes/signal/SIGNAL-PUMP-010-therapy-log-timestamp-discrepancies`
- **status:** `under-assessment`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
- **triggers:** [[06-Infpump FlowGuard ontology notes/change/CHG-PUMP-010-administration-set-compatibility-extension|CHG-PUMP-010]]
...
Succeeding dependencies are ontology notes to which this record leads. The trace continues through `concerns` to [[06-Infpump FlowGuard ontology notes/device-configuration/DEVC-PUMP-005-infpump-flowguard-critical-care-configuration-11|DEVC-PUMP-005 — Infpump FlowGuard critical-care configuration 1.1]]; `triggers` to [[06-Infpump FlowGuard ontology notes/change/CHG-PUMP-010-administration-set-compatibility-extension|CHG-PUMP-010 — Administration-set compatibility extension]]. These outgoing links identify the next product, risk, control, evidence, change or lifecycle records used by downstream reasoning.

The left-to-right diagram shows up to five asserted previous and five asserted succeeding ontology-note dependencies. When more links exist, the additional-dependency node states how many remain available through the verbal links and structured metadata above.

```mermaid
flowchart LR
  CURRENT["SIGNAL-PUMP-010<br/>Therapy-log timestamp discrepancies"]
  ...
  NEXT1["CHG-PUMP-010<br/>Administration-set compatibility extension"]
