---
{
  ...
  "title": "Transport and storage protection",
  "aliases": [
    "CRI-PUMP-008",
    "CRI-PUMP-008-transport-and-storage-protection",
    "18-ontology-notes/compliance-requirement-instance/CRI-PUMP-008-transport-and-storage-protection",
    "03-Ontology notes/compliance-requirement-instance/CRI-PUMP-008-transport-and-storage-protection"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "CRI-PUMP-008",
  ...
  "compliance_method": "Verification and controlled-document review for CRI-PUMP-008",
...
- **type:** `compliance-requirement-instance`
- **title:** `Transport and storage protection`
- **aliases:** `CRI-PUMP-008`, `CRI-PUMP-008-transport-and-storage-protection`, `18-ontology-notes/compliance-requirement-instance/CRI-PUMP-008-transport-and-storage-protection`, `03-Ontology notes/compliance-requirement-instance/CRI-PUMP-008-transport-and-storage-protection`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
```mermaid
flowchart LR
  CURRENT["CRI-PUMP-008<br/>Transport and storage protection"]
