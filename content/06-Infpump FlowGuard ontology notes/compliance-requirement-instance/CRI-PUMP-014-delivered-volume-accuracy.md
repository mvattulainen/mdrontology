---
{
  ...
  "title": "Delivered-volume accuracy",
  "aliases": [
    "CRI-PUMP-014",
    "CRI-PUMP-014-delivered-volume-accuracy",
    "18-ontology-notes/compliance-requirement-instance/CRI-PUMP-014-delivered-volume-accuracy",
    "03-Ontology notes/compliance-requirement-instance/CRI-PUMP-014-delivered-volume-accuracy"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "CRI-PUMP-014",
  ...
  "compliance_method": "Verification and controlled-document review for CRI-PUMP-014",
...
- **type:** `compliance-requirement-instance`
- **title:** `Delivered-volume accuracy`
- **aliases:** `CRI-PUMP-014`, `CRI-PUMP-014-delivered-volume-accuracy`, `18-ontology-notes/compliance-requirement-instance/CRI-PUMP-014-delivered-volume-accuracy`, `03-Ontology notes/compliance-requirement-instance/CRI-PUMP-014-delivered-volume-accuracy`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
```mermaid
flowchart LR
  CURRENT["CRI-PUMP-014<br/>Delivered-volume accuracy"]
