---
{
  ...
  "title": "Biological safety of fluid-path materials",
  "aliases": [
    "CRI-PUMP-010",
    "CRI-PUMP-010-biological-safety-of-fluid-path-materials",
    "18-ontology-notes/compliance-requirement-instance/CRI-PUMP-010-biological-safety-of-fluid-path-materials",
    "03-Ontology notes/compliance-requirement-instance/CRI-PUMP-010-biological-safety-of-fluid-path-materials"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "CRI-PUMP-010",
  ...
  "compliance_method": "Verification and controlled-document review for CRI-PUMP-010",
...
# Biological safety of fluid-path materials
...
- **type:** `compliance-requirement-instance`
- **title:** `Biological safety of fluid-path materials`
- **aliases:** `CRI-PUMP-010`, `CRI-PUMP-010-biological-safety-of-fluid-path-materials`, `18-ontology-notes/compliance-requirement-instance/CRI-PUMP-010-biological-safety-of-fluid-path-materials`, `03-Ontology notes/compliance-requirement-instance/CRI-PUMP-010-biological-safety-of-fluid-path-materials`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
```mermaid
flowchart LR
  CURRENT["CRI-PUMP-010<br/>Biological safety of fluid-path materials"]
