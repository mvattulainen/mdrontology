---
{
  ...
  "title": "Flow-rate accuracy",
  "aliases": [
    "CRI-PUMP-015",
    "CRI-PUMP-015-flow-rate-accuracy",
    "18-ontology-notes/compliance-requirement-instance/CRI-PUMP-015-flow-rate-accuracy",
    "03-Ontology notes/compliance-requirement-instance/CRI-PUMP-015-flow-rate-accuracy"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "CRI-PUMP-015",
  ...
  "compliance_method": "Verification and controlled-document review for CRI-PUMP-015",
...
- **type:** `compliance-requirement-instance`
- **title:** `Flow-rate accuracy`
- **aliases:** `CRI-PUMP-015`, `CRI-PUMP-015-flow-rate-accuracy`, `18-ontology-notes/compliance-requirement-instance/CRI-PUMP-015-flow-rate-accuracy`, `03-Ontology notes/compliance-requirement-instance/CRI-PUMP-015-flow-rate-accuracy`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
- **satisfied_by:** [[06-Infpump FlowGuard ontology notes/verification-evidence/EVD-PUMP-015-human-factors-validation-report|EVD-PUMP-015]]
...
Succeeding dependencies are ontology notes to which this record leads. The trace continues through `satisfied_by` to [[06-Infpump FlowGuard ontology notes/verification-evidence/EVD-PUMP-015-human-factors-validation-report|EVD-PUMP-015 — Human factors validation report]]. These outgoing links identify the next product, risk, control, evidence, change or lifecycle records used by downstream reasoning.

The left-to-right diagram shows up to five asserted previous and five asserted succeeding ontology-note dependencies. When more links exist, the additional-dependency node states how many remain available through the verbal links and structured metadata above.

```mermaid
flowchart LR
  CURRENT["CRI-PUMP-015<br/>Flow-rate accuracy"]
  PREV0["DEVC-PUMP-002<br/>Infpump FlowGuard transport configuration 1.0"]
  PREV0 -->|"has_applicable_requirement"| CURRENT
  NEXT0["EVD-PUMP-015<br/>Human factors validation report"]
