---
{
  ...
  "aliases": [
    "CRI-PUMP-049",
    "CRI-PUMP-049-production-release-controls",
    "18-ontology-notes/compliance-requirement-instance/CRI-PUMP-049-production-release-controls",
    "03-Ontology notes/compliance-requirement-instance/CRI-PUMP-049-production-release-controls"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "CRI-PUMP-049",
  ...
  "compliance_method": "Verification and controlled-document review for CRI-PUMP-049",
...
- **type:** `compliance-requirement-instance`
- **title:** `Production release controls`
- **aliases:** `CRI-PUMP-049`, `CRI-PUMP-049-production-release-controls`, `18-ontology-notes/compliance-requirement-instance/CRI-PUMP-049-production-release-controls`, `03-Ontology notes/compliance-requirement-instance/CRI-PUMP-049-production-release-controls`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
```mermaid
flowchart LR
  CURRENT["CRI-PUMP-049<br/>Production release controls"]
