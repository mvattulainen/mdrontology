---
{
  ...
  "aliases": [
    ...
    "18-ontology-notes/compliance-requirement-instance/CRI-PUMP-004-risk-control-verification",
    "03-Ontology notes/compliance-requirement-instance/CRI-PUMP-004-risk-control-verification"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "CRI-PUMP-004",
  ...
  "compliance_method": "Verification and controlled-document review for CRI-PUMP-004",
...
- **type:** `compliance-requirement-instance`
- **title:** `Risk-control verification`
- **aliases:** `CRI-PUMP-004`, `CRI-PUMP-004-risk-control-verification`, `18-ontology-notes/compliance-requirement-instance/CRI-PUMP-004-risk-control-verification`, `03-Ontology notes/compliance-requirement-instance/CRI-PUMP-004-risk-control-verification`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
```mermaid
flowchart LR
  CURRENT["CRI-PUMP-004<br/>Risk-control verification"]
