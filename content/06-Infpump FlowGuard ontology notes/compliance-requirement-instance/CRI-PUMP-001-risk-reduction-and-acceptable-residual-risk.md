---
{
  ...
  "title": "Risk reduction and acceptable residual risk",
  "aliases": [
    "CRI-PUMP-001",
    "CRI-PUMP-001-risk-reduction-and-acceptable-residual-risk",
    "18-ontology-notes/compliance-requirement-instance/CRI-PUMP-001-risk-reduction-and-acceptable-residual-risk",
    "03-Ontology notes/compliance-requirement-instance/CRI-PUMP-001-risk-reduction-and-acceptable-residual-risk"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "CRI-PUMP-001",
  ...
  "compliance_method": "Verification and controlled-document review for CRI-PUMP-001",
...
# Risk reduction and acceptable residual risk
...
- **type:** `compliance-requirement-instance`
- **title:** `Risk reduction and acceptable residual risk`
- **aliases:** `CRI-PUMP-001`, `CRI-PUMP-001-risk-reduction-and-acceptable-residual-risk`, `18-ontology-notes/compliance-requirement-instance/CRI-PUMP-001-risk-reduction-and-acceptable-residual-risk`, `03-Ontology notes/compliance-requirement-instance/CRI-PUMP-001-risk-reduction-and-acceptable-residual-risk`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
```mermaid
flowchart LR
  CURRENT["CRI-PUMP-001<br/>Risk reduction and acceptable residual risk"]
