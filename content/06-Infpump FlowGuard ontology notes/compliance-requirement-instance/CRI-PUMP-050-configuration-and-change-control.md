---
{
  ...
  "aliases": [
    ...
    "18-ontology-notes/compliance-requirement-instance/CRI-PUMP-050-configuration-and-change-control",
    "03-Ontology notes/compliance-requirement-instance/CRI-PUMP-050-configuration-and-change-control"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "CRI-PUMP-050",
  ...
  "compliance_method": "Verification and controlled-document review for CRI-PUMP-050",
...
- **type:** `compliance-requirement-instance`
- **title:** `Configuration and change control`
- **aliases:** `CRI-PUMP-050`, `CRI-PUMP-050-configuration-and-change-control`, `18-ontology-notes/compliance-requirement-instance/CRI-PUMP-050-configuration-and-change-control`, `03-Ontology notes/compliance-requirement-instance/CRI-PUMP-050-configuration-and-change-control`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
```mermaid
flowchart LR
  CURRENT["CRI-PUMP-050<br/>Configuration and change control"]
