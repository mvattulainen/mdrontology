---
{
  ...
  "title": "Clinical evaluation support",
  "aliases": [
    "CRI-PUMP-046",
    "CRI-PUMP-046-clinical-evaluation-support",
    "18-ontology-notes/compliance-requirement-instance/CRI-PUMP-046-clinical-evaluation-support",
    "03-Ontology notes/compliance-requirement-instance/CRI-PUMP-046-clinical-evaluation-support"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "CRI-PUMP-046",
...
- **type:** `compliance-requirement-instance`
- **title:** `Clinical evaluation support`
- **aliases:** `CRI-PUMP-046`, `CRI-PUMP-046-clinical-evaluation-support`, `18-ontology-notes/compliance-requirement-instance/CRI-PUMP-046-clinical-evaluation-support`, `03-Ontology notes/compliance-requirement-instance/CRI-PUMP-046-clinical-evaluation-support`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
