---
{
  ...
  "title": "Alarm priority and intelligibility",
  "aliases": [
    "CRI-PUMP-020",
    "CRI-PUMP-020-alarm-priority-and-intelligibility",
    "18-ontology-notes/compliance-requirement-instance/CRI-PUMP-020-alarm-priority-and-intelligibility",
    "03-Ontology notes/compliance-requirement-instance/CRI-PUMP-020-alarm-priority-and-intelligibility"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "CRI-PUMP-020",
  ...
  "compliance_method": "Verification and controlled-document review for CRI-PUMP-020",
...
# Alarm priority and intelligibility
...
- **type:** `compliance-requirement-instance`
- **title:** `Alarm priority and intelligibility`
- **aliases:** `CRI-PUMP-020`, `CRI-PUMP-020-alarm-priority-and-intelligibility`, `18-ontology-notes/compliance-requirement-instance/CRI-PUMP-020-alarm-priority-and-intelligibility`, `03-Ontology notes/compliance-requirement-instance/CRI-PUMP-020-alarm-priority-and-intelligibility`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
- **satisfied_by:** [[06-Infpump FlowGuard ontology notes/verification-evidence/EVD-PUMP-020-administration-set-compatibility-report|EVD-PUMP-020]]
...
Succeeding dependencies are ontology notes to which this record leads. The trace continues through `satisfied_by` to [[06-Infpump FlowGuard ontology notes/verification-evidence/EVD-PUMP-020-administration-set-compatibility-report|EVD-PUMP-020 — Administration-set compatibility report]]. These outgoing links identify the next product, risk, control, evidence, change or lifecycle records used by downstream reasoning.

The left-to-right diagram shows up to five asserted previous and five asserted succeeding ontology-note dependencies. When more links exist, the additional-dependency node states how many remain available through the verbal links and structured metadata above.

```mermaid
flowchart LR
  CURRENT["CRI-PUMP-020<br/>Alarm priority and intelligibility"]
  PREV0["DEVC-PUMP-002<br/>Infpump FlowGuard transport configuration 1.0"]
  PREV0 -->|"has_applicable_requirement"| CURRENT
  NEXT0["EVD-PUMP-020<br/>Administration-set compatibility report"]
