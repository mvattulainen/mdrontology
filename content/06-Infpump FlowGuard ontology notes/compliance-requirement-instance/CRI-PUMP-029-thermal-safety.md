---
{
  ...
  "aliases": [
    "CRI-PUMP-029",
    "CRI-PUMP-029-thermal-safety",
    "18-ontology-notes/compliance-requirement-instance/CRI-PUMP-029-thermal-safety",
    "03-Ontology notes/compliance-requirement-instance/CRI-PUMP-029-thermal-safety"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "CRI-PUMP-029",
  ...
  "compliance_method": "Verification and controlled-document review for CRI-PUMP-029",
...
- **type:** `compliance-requirement-instance`
- **title:** `Thermal safety`
- **aliases:** `CRI-PUMP-029`, `CRI-PUMP-029-thermal-safety`, `18-ontology-notes/compliance-requirement-instance/CRI-PUMP-029-thermal-safety`, `03-Ontology notes/compliance-requirement-instance/CRI-PUMP-029-thermal-safety`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
```mermaid
flowchart LR
  CURRENT["CRI-PUMP-029<br/>Thermal safety"]
