---
{
  ...
  "title": "Labelling content",
  "aliases": [
    "CRI-PUMP-043",
    "CRI-PUMP-043-labelling-content",
    "18-ontology-notes/compliance-requirement-instance/CRI-PUMP-043-labelling-content",
    "03-Ontology notes/compliance-requirement-instance/CRI-PUMP-043-labelling-content"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "CRI-PUMP-043",
  ...
  "compliance_method": "Verification and controlled-document review for CRI-PUMP-043",
...
- **type:** `compliance-requirement-instance`
- **title:** `Labelling content`
- **aliases:** `CRI-PUMP-043`, `CRI-PUMP-043-labelling-content`, `18-ontology-notes/compliance-requirement-instance/CRI-PUMP-043-labelling-content`, `03-Ontology notes/compliance-requirement-instance/CRI-PUMP-043-labelling-content`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
- **satisfied_by:** [[06-Infpump FlowGuard ontology notes/verification-evidence/EVD-PUMP-013-security-update-verification-report|EVD-PUMP-013]]
