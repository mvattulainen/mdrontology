---
{
  ...
  "title": "Air-in-line detection",
  "aliases": [
    "CRI-PUMP-018",
    "CRI-PUMP-018-air-in-line-detection",
    "18-ontology-notes/compliance-requirement-instance/CRI-PUMP-018-air-in-line-detection",
    "03-Ontology notes/compliance-requirement-instance/CRI-PUMP-018-air-in-line-detection"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "CRI-PUMP-018",
  ...
  "compliance_method": "Verification and controlled-document review for CRI-PUMP-018",
...
- **type:** `compliance-requirement-instance`
- **title:** `Air-in-line detection`
- **aliases:** `CRI-PUMP-018`, `CRI-PUMP-018-air-in-line-detection`, `18-ontology-notes/compliance-requirement-instance/CRI-PUMP-018-air-in-line-detection`, `03-Ontology notes/compliance-requirement-instance/CRI-PUMP-018-air-in-line-detection`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
```mermaid
flowchart LR
  CURRENT["CRI-PUMP-018<br/>Air-in-line detection"]
