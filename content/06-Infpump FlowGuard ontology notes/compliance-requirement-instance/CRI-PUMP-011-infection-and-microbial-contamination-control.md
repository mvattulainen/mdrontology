---
{
  ...
  "title": "Infection and microbial contamination control",
  "aliases": [
    "CRI-PUMP-011",
    "CRI-PUMP-011-infection-and-microbial-contamination-control",
    "18-ontology-notes/compliance-requirement-instance/CRI-PUMP-011-infection-and-microbial-contamination-control",
    "03-Ontology notes/compliance-requirement-instance/CRI-PUMP-011-infection-and-microbial-contamination-control"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "CRI-PUMP-011",
  ...
  "compliance_method": "Verification and controlled-document review for CRI-PUMP-011",
...
- **type:** `compliance-requirement-instance`
- **title:** `Infection and microbial contamination control`
- **aliases:** `CRI-PUMP-011`, `CRI-PUMP-011-infection-and-microbial-contamination-control`, `18-ontology-notes/compliance-requirement-instance/CRI-PUMP-011-infection-and-microbial-contamination-control`, `03-Ontology notes/compliance-requirement-instance/CRI-PUMP-011-infection-and-microbial-contamination-control`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
- **satisfied_by:** [[06-Infpump FlowGuard ontology notes/verification-evidence/EVD-PUMP-011-software-unit-verification-summary|EVD-PUMP-011]]
...
Succeeding dependencies are ontology notes to which this record leads. The trace continues through `satisfied_by` to [[06-Infpump FlowGuard ontology notes/verification-evidence/EVD-PUMP-011-software-unit-verification-summary|EVD-PUMP-011 — Software unit verification summary]]. These outgoing links identify the next product, risk, control, evidence, change or lifecycle records used by downstream reasoning.

The left-to-right diagram shows up to five asserted previous and five asserted succeeding ontology-note dependencies. When more links exist, the additional-dependency node states how many remain available through the verbal links and structured metadata above.

```mermaid
flowchart LR
  CURRENT["CRI-PUMP-011<br/>Infection and microbial contamination control"]
  PREV0["DEVC-PUMP-002<br/>Infpump FlowGuard transport configuration 1.0"]
  PREV0 -->|"has_applicable_requirement"| CURRENT
  NEXT0["EVD-PUMP-011<br/>Software unit verification summary"]
