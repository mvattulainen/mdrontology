---
{
  ...
  "aliases": [
    "CRI-PUMP-013",
    "CRI-PUMP-013-measurement-accuracy",
    "18-ontology-notes/compliance-requirement-instance/CRI-PUMP-013-measurement-accuracy",
    "03-Ontology notes/compliance-requirement-instance/CRI-PUMP-013-measurement-accuracy"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "CRI-PUMP-013",
  ...
  "compliance_method": "Verification and controlled-document review for CRI-PUMP-013",
...
- **type:** `compliance-requirement-instance`
- **title:** `Measurement accuracy`
- **aliases:** `CRI-PUMP-013`, `CRI-PUMP-013-measurement-accuracy`, `18-ontology-notes/compliance-requirement-instance/CRI-PUMP-013-measurement-accuracy`, `03-Ontology notes/compliance-requirement-instance/CRI-PUMP-013-measurement-accuracy`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
```mermaid
flowchart LR
  CURRENT["CRI-PUMP-013<br/>Measurement accuracy"]
