---
{
  ...
  "aliases": [
    "CRI-PUMP-038",
    "CRI-PUMP-038-interoperability",
    "18-ontology-notes/compliance-requirement-instance/CRI-PUMP-038-interoperability",
    "03-Ontology notes/compliance-requirement-instance/CRI-PUMP-038-interoperability"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "CRI-PUMP-038",
  ...
  "compliance_method": "Verification and controlled-document review for CRI-PUMP-038",
...
- **type:** `compliance-requirement-instance`
- **title:** `Interoperability`
- **aliases:** `CRI-PUMP-038`, `CRI-PUMP-038-interoperability`, `18-ontology-notes/compliance-requirement-instance/CRI-PUMP-038-interoperability`, `03-Ontology notes/compliance-requirement-instance/CRI-PUMP-038-interoperability`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
```mermaid
flowchart LR
  CURRENT["CRI-PUMP-038<br/>Interoperability"]
