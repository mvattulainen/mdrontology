---
{
  ...
  "aliases": [
    "CRI-PUMP-047",
    "CRI-PUMP-047-pms-planning",
    "18-ontology-notes/compliance-requirement-instance/CRI-PUMP-047-pms-planning",
    "03-Ontology notes/compliance-requirement-instance/CRI-PUMP-047-pms-planning"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "CRI-PUMP-047",
  ...
  "compliance_method": "Verification and controlled-document review for CRI-PUMP-047",
...
- **type:** `compliance-requirement-instance`
- **title:** `PMS planning`
- **aliases:** `CRI-PUMP-047`, `CRI-PUMP-047-pms-planning`, `18-ontology-notes/compliance-requirement-instance/CRI-PUMP-047-pms-planning`, `03-Ontology notes/compliance-requirement-instance/CRI-PUMP-047-pms-planning`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
```mermaid
flowchart LR
  CURRENT["CRI-PUMP-047<br/>PMS planning"]
