---
{
  ...
  "title": "UDI traceability",
  "aliases": [
    "CRI-PUMP-045",
    "CRI-PUMP-045-udi-traceability",
    "18-ontology-notes/compliance-requirement-instance/CRI-PUMP-045-udi-traceability",
    "03-Ontology notes/compliance-requirement-instance/CRI-PUMP-045-udi-traceability"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "CRI-PUMP-045",
  ...
  "compliance_method": "Verification and controlled-document review for CRI-PUMP-045",
...
- **type:** `compliance-requirement-instance`
- **title:** `UDI traceability`
- **aliases:** `CRI-PUMP-045`, `CRI-PUMP-045-udi-traceability`, `18-ontology-notes/compliance-requirement-instance/CRI-PUMP-045-udi-traceability`, `03-Ontology notes/compliance-requirement-instance/CRI-PUMP-045-udi-traceability`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
```mermaid
flowchart LR
  CURRENT["CRI-PUMP-045<br/>UDI traceability"]
