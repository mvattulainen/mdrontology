---
{
  ...
  "title": "Protection against unintended bolus",
  "aliases": [
    "CRI-PUMP-016",
    "CRI-PUMP-016-protection-against-unintended-bolus",
    "18-ontology-notes/compliance-requirement-instance/CRI-PUMP-016-protection-against-unintended-bolus",
    "03-Ontology notes/compliance-requirement-instance/CRI-PUMP-016-protection-against-unintended-bolus"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "CRI-PUMP-016",
  ...
  "compliance_method": "Verification and controlled-document review for CRI-PUMP-016",
...
# Protection against unintended bolus
...
- **type:** `compliance-requirement-instance`
- **title:** `Protection against unintended bolus`
- **aliases:** `CRI-PUMP-016`, `CRI-PUMP-016-protection-against-unintended-bolus`, `18-ontology-notes/compliance-requirement-instance/CRI-PUMP-016-protection-against-unintended-bolus`, `03-Ontology notes/compliance-requirement-instance/CRI-PUMP-016-protection-against-unintended-bolus`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
```mermaid
flowchart LR
  CURRENT["CRI-PUMP-016<br/>Protection against unintended bolus"]
