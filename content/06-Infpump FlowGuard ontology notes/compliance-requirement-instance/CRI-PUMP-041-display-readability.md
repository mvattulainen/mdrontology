---
{
  ...
  "aliases": [
    "CRI-PUMP-041",
    "CRI-PUMP-041-display-readability",
    "18-ontology-notes/compliance-requirement-instance/CRI-PUMP-041-display-readability",
    "03-Ontology notes/compliance-requirement-instance/CRI-PUMP-041-display-readability"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "CRI-PUMP-041",
  ...
  "compliance_method": "Verification and controlled-document review for CRI-PUMP-041",
...
- **type:** `compliance-requirement-instance`
- **title:** `Display readability`
- **aliases:** `CRI-PUMP-041`, `CRI-PUMP-041-display-readability`, `18-ontology-notes/compliance-requirement-instance/CRI-PUMP-041-display-readability`, `03-Ontology notes/compliance-requirement-instance/CRI-PUMP-041-display-readability`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
```mermaid
flowchart LR
  CURRENT["CRI-PUMP-041<br/>Display readability"]
