---
{
  ...
  "aliases": [
    "CRI-PUMP-023",
    "CRI-PUMP-023-electromagnetic-compatibility",
    "18-ontology-notes/compliance-requirement-instance/CRI-PUMP-023-electromagnetic-compatibility",
    "03-Ontology notes/compliance-requirement-instance/CRI-PUMP-023-electromagnetic-compatibility"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "CRI-PUMP-023",
  ...
  "compliance_method": "Verification and controlled-document review for CRI-PUMP-023",
...
- **type:** `compliance-requirement-instance`
- **title:** `Electromagnetic compatibility`
- **aliases:** `CRI-PUMP-023`, `CRI-PUMP-023-electromagnetic-compatibility`, `18-ontology-notes/compliance-requirement-instance/CRI-PUMP-023-electromagnetic-compatibility`, `03-Ontology notes/compliance-requirement-instance/CRI-PUMP-023-electromagnetic-compatibility`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
- **satisfied_by:** [[06-Infpump FlowGuard ontology notes/verification-evidence/EVD-PUMP-023-packaging-and-transport-test-report|EVD-PUMP-023]]
...
Succeeding dependencies are ontology notes to which this record leads. The trace continues through `satisfied_by` to [[06-Infpump FlowGuard ontology notes/verification-evidence/EVD-PUMP-023-packaging-and-transport-test-report|EVD-PUMP-023 — Packaging and transport test report]]. These outgoing links identify the next product, risk, control, evidence, change or lifecycle records used by downstream reasoning.

The left-to-right diagram shows up to five asserted previous and five asserted succeeding ontology-note dependencies. When more links exist, the additional-dependency node states how many remain available through the verbal links and structured metadata above.

```mermaid
flowchart LR
  CURRENT["CRI-PUMP-023<br/>Electromagnetic compatibility"]
  PREV0["DEVC-PUMP-003<br/>Infpump FlowGuard paediatric configuration 1.0"]
  PREV0 -->|"has_applicable_requirement"| CURRENT
  NEXT0["EVD-PUMP-023<br/>Packaging and transport test report"]
