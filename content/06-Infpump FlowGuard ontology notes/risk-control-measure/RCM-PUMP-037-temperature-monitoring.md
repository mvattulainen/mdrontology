---
{
  ...
  "aliases": [
    "RCM-PUMP-037",
    "RCM-PUMP-037-temperature-monitoring",
    "18-ontology-notes/risk-control-measure/RCM-PUMP-037-temperature-monitoring",
    "03-Ontology notes/risk-control-measure/RCM-PUMP-037-temperature-monitoring"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "RCM-PUMP-037",
...
- **type:** `risk-control-measure`
- **title:** `Temperature monitoring`
- **aliases:** `RCM-PUMP-037`, `RCM-PUMP-037-temperature-monitoring`, `18-ontology-notes/risk-control-measure/RCM-PUMP-037-temperature-monitoring`, `03-Ontology notes/risk-control-measure/RCM-PUMP-037-temperature-monitoring`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
- **device_context:** [[06-Infpump FlowGuard ontology notes/device-configuration/DEVC-PUMP-002-infpump-flowguard-transport-configuration-10|DEVC-PUMP-002]]
- **control_priority:** `information-for-safety-or-production-control`
- **mitigates:** [[06-Infpump FlowGuard ontology notes/risk/RISK-PUMP-037-clinical-injury-following-microbial-contamination|RISK-PUMP-037]]
...
Succeeding dependencies are ontology notes to which this record leads. The trace continues through `mitigates` to [[06-Infpump FlowGuard ontology notes/risk/RISK-PUMP-037-clinical-injury-following-microbial-contamination|RISK-PUMP-037 — Clinical injury following microbial contamination]]; `verified_by` to [[06-Infpump FlowGuard ontology notes/verification-evidence/EVD-PUMP-007-battery-endurance-validation-report|EVD-PUMP-007 — Battery endurance validation report]]. These outgoing links identify the next product, risk, control, evidence, change or lifecycle records used by downstream reasoning.

The left-to-right diagram shows up to five asserted previous and five asserted succeeding ontology-note dependencies. When more links exist, the additional-dependency node states how many remain available through the verbal links and structured metadata above.

```mermaid
flowchart LR
  CURRENT["RCM-PUMP-037<br/>Temperature monitoring"]
  PREV_NONE["No asserted previous dependency"]
  PREV_NONE -.-> CURRENT
  NEXT0["RISK-PUMP-037<br/>Clinical injury following microbial contamination"]
