---
{
  ...
  "title": "Occlusion alarm escalation",
  "aliases": [
    "RCM-PUMP-005",
    "RCM-PUMP-005-occlusion-alarm-escalation",
    "18-ontology-notes/risk-control-measure/RCM-PUMP-005-occlusion-alarm-escalation",
    "03-Ontology notes/risk-control-measure/RCM-PUMP-005-occlusion-alarm-escalation"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
...
- **type:** `risk-control-measure`
- **title:** `Occlusion alarm escalation`
- **aliases:** `RCM-PUMP-005`, `RCM-PUMP-005-occlusion-alarm-escalation`, `18-ontology-notes/risk-control-measure/RCM-PUMP-005-occlusion-alarm-escalation`, `03-Ontology notes/risk-control-measure/RCM-PUMP-005-occlusion-alarm-escalation`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
```mermaid
flowchart LR
  CURRENT["RCM-PUMP-005<br/>Occlusion alarm escalation"]
