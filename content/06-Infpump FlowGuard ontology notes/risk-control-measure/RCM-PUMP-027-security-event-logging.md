---
{
  ...
  "aliases": [
    "RCM-PUMP-027",
    "RCM-PUMP-027-security-event-logging",
    "18-ontology-notes/risk-control-measure/RCM-PUMP-027-security-event-logging",
    "03-Ontology notes/risk-control-measure/RCM-PUMP-027-security-event-logging"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "RCM-PUMP-027",
...
- **type:** `risk-control-measure`
- **title:** `Security event logging`
- **aliases:** `RCM-PUMP-027`, `RCM-PUMP-027-security-event-logging`, `18-ontology-notes/risk-control-measure/RCM-PUMP-027-security-event-logging`, `03-Ontology notes/risk-control-measure/RCM-PUMP-027-security-event-logging`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
- **device_context:** [[06-Infpump FlowGuard ontology notes/device-configuration/DEVC-PUMP-002-infpump-flowguard-transport-configuration-10|DEVC-PUMP-002]]
- **control_priority:** `inherent-safety-or-protective-measure`
- **mitigates:** [[06-Infpump FlowGuard ontology notes/risk/RISK-PUMP-027-clinical-injury-following-fluid-ingress-into-enclosure|RISK-PUMP-027]]
- **verified_by:** [[06-Infpump FlowGuard ontology notes/verification-evidence/EVD-PUMP-027-event-clock-accuracy-report|EVD-PUMP-027]]
...
Succeeding dependencies are ontology notes to which this record leads. The trace continues through `mitigates` to [[06-Infpump FlowGuard ontology notes/risk/RISK-PUMP-027-clinical-injury-following-fluid-ingress-into-enclosure|RISK-PUMP-027 — Clinical injury following fluid ingress into enclosure]]; `verified_by` to [[06-Infpump FlowGuard ontology notes/verification-evidence/EVD-PUMP-027-event-clock-accuracy-report|EVD-PUMP-027 — Event-clock accuracy report]]. These outgoing links identify the next product, risk, control, evidence, change or lifecycle records used by downstream reasoning.

The left-to-right diagram shows up to five asserted previous and five asserted succeeding ontology-note dependencies. When more links exist, the additional-dependency node states how many remain available through the verbal links and structured metadata above.

```mermaid
flowchart LR
  CURRENT["RCM-PUMP-027<br/>Security event logging"]
  PREV_NONE["No asserted previous dependency"]
  PREV_NONE -.-> CURRENT
  NEXT0["RISK-PUMP-027<br/>Clinical injury following fluid ingress into enclosure"]
  CURRENT -->|"mitigates"| NEXT0
  NEXT1["EVD-PUMP-027<br/>Event-clock accuracy report"]
