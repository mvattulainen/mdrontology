...
- **device_context:** [[06-Infpump FlowGuard ontology notes/device-configuration/DEVC-PUMP-001-infpump-flowguard-bedside-configuration-10|DEVC-PUMP-001]]
- **control_priority:** `inherent-safety-or-protective-measure`
- **mitigates:** [[06-Infpump FlowGuard ontology notes/risk/RISK-PUMP-006-delayed-detection-or-secondary-harm-from-occluded-infusion-pathway|RISK-PUMP-006]]
...
Succeeding dependencies are ontology notes to which this record leads. The trace continues through `mitigates` to [[06-Infpump FlowGuard ontology notes/risk/RISK-PUMP-006-delayed-detection-or-secondary-harm-from-occluded-infusion-pathway|RISK-PUMP-006 — Delayed detection or secondary harm from occluded infusion pathway]]; `verified_by` to [[06-Infpump FlowGuard ontology notes/verification-evidence/EVD-PUMP-006-drug-library-limits-verification-report|EVD-PUMP-006 — Drug-library limits verification report]]. These outgoing links identify the next product, risk, control, evidence, change or lifecycle records used by downstream reasoning.
...
flowchart LR
  ...
  PREV_NONE -.-> CURRENT
  NEXT0["RISK-PUMP-006<br/>Delayed detection or secondary harm from occluded infusion pathway"]
