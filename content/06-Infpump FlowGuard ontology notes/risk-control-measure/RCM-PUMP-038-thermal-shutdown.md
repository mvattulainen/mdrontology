---
{
  ...
  "aliases": [
    "RCM-PUMP-038",
    "RCM-PUMP-038-thermal-shutdown",
    "18-ontology-notes/risk-control-measure/RCM-PUMP-038-thermal-shutdown",
    "03-Ontology notes/risk-control-measure/RCM-PUMP-038-thermal-shutdown"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "RCM-PUMP-038",
...
- **type:** `risk-control-measure`
- **title:** `Thermal shutdown`
- **aliases:** `RCM-PUMP-038`, `RCM-PUMP-038-thermal-shutdown`, `18-ontology-notes/risk-control-measure/RCM-PUMP-038-thermal-shutdown`, `03-Ontology notes/risk-control-measure/RCM-PUMP-038-thermal-shutdown`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
- **device_context:** [[06-Infpump FlowGuard ontology notes/device-configuration/DEVC-PUMP-003-infpump-flowguard-paediatric-configuration-10|DEVC-PUMP-003]]
- **control_priority:** `information-for-safety-or-production-control`
- **mitigates:** [[06-Infpump FlowGuard ontology notes/risk/RISK-PUMP-038-delayed-detection-or-secondary-harm-from-microbial-contamination|RISK-PUMP-038]]
...
Succeeding dependencies are ontology notes to which this record leads. The trace continues through `mitigates` to [[06-Infpump FlowGuard ontology notes/risk/RISK-PUMP-038-delayed-detection-or-secondary-harm-from-microbial-contamination|RISK-PUMP-038 — Delayed detection or secondary harm from microbial contamination]]; `verified_by` to [[06-Infpump FlowGuard ontology notes/verification-evidence/EVD-PUMP-008-electrical-safety-test-report|EVD-PUMP-008 — Electrical safety test report]]. These outgoing links identify the next product, risk, control, evidence, change or lifecycle records used by downstream reasoning.

The left-to-right diagram shows up to five asserted previous and five asserted succeeding ontology-note dependencies. When more links exist, the additional-dependency node states how many remain available through the verbal links and structured metadata above.

```mermaid
flowchart LR
  CURRENT["RCM-PUMP-038<br/>Thermal shutdown"]
  PREV_NONE["No asserted previous dependency"]
  PREV_NONE -.-> CURRENT
  NEXT0["RISK-PUMP-038<br/>Delayed detection or secondary harm from microbial contamination"]
