---
{
  ...
  "title": "Critical-battery controlled shutdown",
  "aliases": [
    "RCM-PUMP-015",
    "RCM-PUMP-015-critical-battery-controlled-shutdown",
    "18-ontology-notes/risk-control-measure/RCM-PUMP-015-critical-battery-controlled-shutdown",
    "03-Ontology notes/risk-control-measure/RCM-PUMP-015-critical-battery-controlled-shutdown"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "RCM-PUMP-015",
...
# Critical-battery controlled shutdown
...
- **type:** `risk-control-measure`
- **title:** `Critical-battery controlled shutdown`
- **aliases:** `RCM-PUMP-015`, `RCM-PUMP-015-critical-battery-controlled-shutdown`, `18-ontology-notes/risk-control-measure/RCM-PUMP-015-critical-battery-controlled-shutdown`, `03-Ontology notes/risk-control-measure/RCM-PUMP-015-critical-battery-controlled-shutdown`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
Succeeding dependencies are ontology notes to which this record leads. The trace continues through `mitigates` to [[06-Infpump FlowGuard ontology notes/risk/RISK-PUMP-015-clinical-injury-following-electrical-isolation-failure|RISK-PUMP-015 — Clinical injury following electrical isolation failure]]; `verified_by` to [[06-Infpump FlowGuard ontology notes/verification-evidence/EVD-PUMP-015-human-factors-validation-report|EVD-PUMP-015 — Human factors validation report]]. These outgoing links identify the next product, risk, control, evidence, change or lifecycle records used by downstream reasoning.

The left-to-right diagram shows up to five asserted previous and five asserted succeeding ontology-note dependencies. When more links exist, the additional-dependency node states how many remain available through the verbal links and structured metadata above.

```mermaid
flowchart LR
  CURRENT["RCM-PUMP-015<br/>Critical-battery controlled shutdown"]
