---
{
  ...
  "title": "Monotonic event time source",
  "aliases": [
    "RCM-PUMP-039",
    "RCM-PUMP-039-monotonic-event-time-source",
    "18-ontology-notes/risk-control-measure/RCM-PUMP-039-monotonic-event-time-source",
    "03-Ontology notes/risk-control-measure/RCM-PUMP-039-monotonic-event-time-source"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "RCM-PUMP-039",
...
- **type:** `risk-control-measure`
- **title:** `Monotonic event time source`
- **aliases:** `RCM-PUMP-039`, `RCM-PUMP-039-monotonic-event-time-source`, `18-ontology-notes/risk-control-measure/RCM-PUMP-039-monotonic-event-time-source`, `03-Ontology notes/risk-control-measure/RCM-PUMP-039-monotonic-event-time-source`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
- **device_context:** [[06-Infpump FlowGuard ontology notes/device-configuration/DEVC-PUMP-004-infpump-flowguard-oncology-configuration-11|DEVC-PUMP-004]]
- **control_priority:** `information-for-safety-or-production-control`
- **mitigates:** [[06-Infpump FlowGuard ontology notes/risk/RISK-PUMP-039-clinical-injury-following-use-error-during-setup|RISK-PUMP-039]]
...
Succeeding dependencies are ontology notes to which this record leads. The trace continues through `mitigates` to [[06-Infpump FlowGuard ontology notes/risk/RISK-PUMP-039-clinical-injury-following-use-error-during-setup|RISK-PUMP-039 — Clinical injury following use error during setup]]; `verified_by` to [[06-Infpump FlowGuard ontology notes/verification-evidence/EVD-PUMP-009-emc-test-report|EVD-PUMP-009 — EMC test report]]. These outgoing links identify the next product, risk, control, evidence, change or lifecycle records used by downstream reasoning.

The left-to-right diagram shows up to five asserted previous and five asserted succeeding ontology-note dependencies. When more links exist, the additional-dependency node states how many remain available through the verbal links and structured metadata above.

```mermaid
flowchart LR
  CURRENT["RCM-PUMP-039<br/>Monotonic event time source"]
  PREV_NONE["No asserted previous dependency"]
  PREV_NONE -.-> CURRENT
  NEXT0["RISK-PUMP-039<br/>Clinical injury following use error during setup"]
