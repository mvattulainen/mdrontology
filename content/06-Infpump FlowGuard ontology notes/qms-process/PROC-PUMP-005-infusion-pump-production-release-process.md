---
{
  "id": "PROC-PUMP-005",
  "type": "qms-process",
  "title": "Infusion-pump production release process",
  "aliases": [
    "PROC-PUMP-005",
    "PROC-PUMP-005-infusion-pump-production-release-process",
    "18-ontology-notes/qms-process/PROC-PUMP-005-infusion-pump-production-release-process",
    "03-Ontology notes/qms-process/PROC-PUMP-005-infusion-pump-production-release-process"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "PROC-PUMP-005",
...
# Infusion-pump production release process
...
- **type:** `qms-process`
- **title:** `Infusion-pump production release process`
- **aliases:** `PROC-PUMP-005`, `PROC-PUMP-005-infusion-pump-production-release-process`, `18-ontology-notes/qms-process/PROC-PUMP-005-infusion-pump-production-release-process`, `03-Ontology notes/qms-process/PROC-PUMP-005-infusion-pump-production-release-process`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
- **device_context:** [[06-Infpump FlowGuard ontology notes/device-configuration/DEVC-PUMP-005-infpump-flowguard-critical-care-configuration-11|DEVC-PUMP-005]]
- **process_state:** `effective`
- **owned_by:** [[01-Ontology instances/02-organisations/roles/ROLE-QUALITY-quality|ROLE-QUALITY]]
...
```mermaid
flowchart LR
  CURRENT["PROC-PUMP-005<br/>Infusion-pump production release process"]
