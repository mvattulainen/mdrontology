---
{
  ...
  "title": "Contaminated fluid path contacts the patient",
  "aliases": [
    "HS-PUMP-019",
    "HS-PUMP-019-contaminated-fluid-path-contacts-the-patient",
    "18-ontology-notes/hazardous-situation/HS-PUMP-019-contaminated-fluid-path-contacts-the-patient",
    "03-Ontology notes/hazardous-situation/HS-PUMP-019-contaminated-fluid-path-contacts-the-patient"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "HS-PUMP-019",
...
# Contaminated fluid path contacts the patient
...
- **type:** `hazardous-situation`
- **title:** `Contaminated fluid path contacts the patient`
- **aliases:** `HS-PUMP-019`, `HS-PUMP-019-contaminated-fluid-path-contacts-the-patient`, `18-ontology-notes/hazardous-situation/HS-PUMP-019-contaminated-fluid-path-contacts-the-patient`, `03-Ontology notes/hazardous-situation/HS-PUMP-019-contaminated-fluid-path-contacts-the-patient`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
Previous dependencies are ontology notes that lead into this record. They reach it through `can_lead_to` from [[06-Infpump FlowGuard ontology notes/hazard/HAZ-PUMP-019-microbial-contamination|HAZ-PUMP-019 — Microbial contamination]]. These incoming links show which product, decision, process or evidence records depend on the current note.
...
```mermaid
flowchart LR
  CURRENT["HS-PUMP-019<br/>Contaminated fluid path contacts the patient"]
  PREV0["HAZ-PUMP-019<br/>Microbial contamination"]
