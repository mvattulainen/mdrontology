---
{
  "id": "HAZ-PUMP-020",
  "type": "hazard",
  "title": "Use error during setup",
  "aliases": [
    "HAZ-PUMP-020",
    "HAZ-PUMP-020-use-error-during-setup",
    "18-ontology-notes/hazard/HAZ-PUMP-020-use-error-during-setup",
    "03-Ontology notes/hazard/HAZ-PUMP-020-use-error-during-setup"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "HAZ-PUMP-020",
  ...
  "can_lead_to": [
    "[[06-Infpump FlowGuard ontology notes/hazardous-situation/HS-PUMP-020-pump-is-started-with-an-incomplete-or-incorrect-setup|HS-PUMP-020]]"
  ]
}
---

# Use error during setup
...
- **type:** `hazard`
- **title:** `Use error during setup`
- **aliases:** `HAZ-PUMP-020`, `HAZ-PUMP-020-use-error-during-setup`, `18-ontology-notes/hazard/HAZ-PUMP-020-use-error-during-setup`, `03-Ontology notes/hazard/HAZ-PUMP-020-use-error-during-setup`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
- **device_context:** [[06-Infpump FlowGuard ontology notes/device-configuration/DEVC-PUMP-005-infpump-flowguard-critical-care-configuration-11|DEVC-PUMP-005]]
- **hazard_category:** `mechanical-use-environment`
- **can_lead_to:** [[06-Infpump FlowGuard ontology notes/hazardous-situation/HS-PUMP-020-pump-is-started-with-an-incomplete-or-incorrect-setup|HS-PUMP-020]]
...
Succeeding dependencies are ontology notes to which this record leads. The trace continues through `can_lead_to` to [[06-Infpump FlowGuard ontology notes/hazardous-situation/HS-PUMP-020-pump-is-started-with-an-incomplete-or-incorrect-setup|HS-PUMP-020 — Pump is started with an incomplete or incorrect setup]]. These outgoing links identify the next product, risk, control, evidence, change or lifecycle records used by downstream reasoning.

The left-to-right diagram shows up to five asserted previous and five asserted succeeding ontology-note dependencies. When more links exist, the additional-dependency node states how many remain available through the verbal links and structured metadata above.

```mermaid
flowchart LR
  CURRENT["HAZ-PUMP-020<br/>Use error during setup"]
  PREV0["DEVC-PUMP-005<br/>Infpump FlowGuard critical-care configuration 1.1"]
  PREV0 -->|"has_hazard"| CURRENT
  NEXT0["HS-PUMP-020<br/>Pump is started with an incomplete or incorrect setup"]
