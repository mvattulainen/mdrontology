---
{
  ...
  "aliases": [
    "COMP-PUMP-008",
    "COMP-PUMP-008-network-communication-module",
    "18-ontology-notes/component/COMP-PUMP-008-network-communication-module",
    "03-Ontology notes/component/COMP-PUMP-008-network-communication-module"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "COMP-PUMP-008",
...
- **type:** `component`
- **title:** `Network communication module`
- **aliases:** `COMP-PUMP-008`, `COMP-PUMP-008-network-communication-module`, `18-ontology-notes/component/COMP-PUMP-008-network-communication-module`, `03-Ontology notes/component/COMP-PUMP-008-network-communication-module`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
Previous dependencies are ontology notes that lead into this record. They reach it through `includes_component` from [[06-Infpump FlowGuard ontology notes/device-configuration/DEVC-PUMP-004-infpump-flowguard-oncology-configuration-11|DEVC-PUMP-004 — Infpump FlowGuard oncology configuration 1.1]]; `supplied_component` from [[06-Infpump FlowGuard ontology notes/supplier/SUP-PUMP-004-alarm-speaker-critical-supplier|SUP-PUMP-004 — Alarm speaker critical supplier]]. These incoming links show which product, decision, process or evidence records depend on the current note.
...
```mermaid
flowchart LR
  CURRENT["COMP-PUMP-008<br/>Network communication module"]
  PREV0["DEVC-PUMP-004<br/>Infpump FlowGuard oncology configuration 1.1"]
  PREV0 -->|"includes_component"| CURRENT
  PREV1["SUP-PUMP-004<br/>Alarm speaker critical supplier"]
