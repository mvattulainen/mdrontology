---
{
  "id": "COMP-PUMP-005",
  "type": "component",
  "title": "Touchscreen user interface",
  "aliases": [
    "COMP-PUMP-005",
    "COMP-PUMP-005-touchscreen-user-interface",
    "18-ontology-notes/component/COMP-PUMP-005-touchscreen-user-interface",
    "03-Ontology notes/component/COMP-PUMP-005-touchscreen-user-interface"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "COMP-PUMP-005",
...
- **type:** `component`
- **title:** `Touchscreen user interface`
- **aliases:** `COMP-PUMP-005`, `COMP-PUMP-005-touchscreen-user-interface`, `18-ontology-notes/component/COMP-PUMP-005-touchscreen-user-interface`, `03-Ontology notes/component/COMP-PUMP-005-touchscreen-user-interface`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
Previous dependencies are ontology notes that lead into this record. They reach it through `includes_component` from [[06-Infpump FlowGuard ontology notes/device-configuration/DEVC-PUMP-003-infpump-flowguard-paediatric-configuration-10|DEVC-PUMP-003 — Infpump FlowGuard paediatric configuration 1.0]]. These incoming links show which product, decision, process or evidence records depend on the current note.
...
```mermaid
flowchart LR
  CURRENT["COMP-PUMP-005<br/>Touchscreen user interface"]
