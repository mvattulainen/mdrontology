---
{
  ...
  "aliases": [
    "COMP-PUMP-003",
    "COMP-PUMP-003-pressure-sensor-assembly",
    "18-ontology-notes/component/COMP-PUMP-003-pressure-sensor-assembly",
    "03-Ontology notes/component/COMP-PUMP-003-pressure-sensor-assembly"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "COMP-PUMP-003",
...
- **type:** `component`
- **title:** `Pressure sensor assembly`
- **aliases:** `COMP-PUMP-003`, `COMP-PUMP-003-pressure-sensor-assembly`, `18-ontology-notes/component/COMP-PUMP-003-pressure-sensor-assembly`, `03-Ontology notes/component/COMP-PUMP-003-pressure-sensor-assembly`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
Previous dependencies are ontology notes that lead into this record. They reach it through `includes_component` from [[06-Infpump FlowGuard ontology notes/device-configuration/DEVC-PUMP-002-infpump-flowguard-transport-configuration-10|DEVC-PUMP-002 — Infpump FlowGuard transport configuration 1.0]]. These incoming links show which product, decision, process or evidence records depend on the current note.
...
```mermaid
flowchart LR
  CURRENT["COMP-PUMP-003<br/>Pressure sensor assembly"]
