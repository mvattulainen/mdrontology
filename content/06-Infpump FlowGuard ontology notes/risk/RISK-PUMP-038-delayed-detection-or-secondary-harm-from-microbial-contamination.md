---
{
  "id": "RISK-PUMP-038",
  "type": "risk",
  "title": "Delayed detection or secondary harm from microbial contamination",
  "aliases": [
    "RISK-PUMP-038",
    "RISK-PUMP-038-delayed-detection-or-secondary-harm-from-microbial-contamination",
    "18-ontology-notes/risk/RISK-PUMP-038-delayed-detection-or-secondary-harm-from-microbial-contamination",
    "03-Ontology notes/risk/RISK-PUMP-038-delayed-detection-or-secondary-harm-from-microbial-contamination"
  ],
  "status": "accepted",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "RISK-PUMP-038",
  ...
  "risk_matrix_identifier": "RISK-PUMP-038",
  "initial_risk": "medium",
  "residual_risk": "low",
  "concerns": [
...
# Delayed detection or secondary harm from microbial contamination
...
- **type:** `risk`
- **title:** `Delayed detection or secondary harm from microbial contamination`
- **aliases:** `RISK-PUMP-038`, `RISK-PUMP-038-delayed-detection-or-secondary-harm-from-microbial-contamination`, `18-ontology-notes/risk/RISK-PUMP-038-delayed-detection-or-secondary-harm-from-microbial-contamination`, `03-Ontology notes/risk/RISK-PUMP-038-delayed-detection-or-secondary-harm-from-microbial-contamination`
- **status:** `accepted`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
```mermaid
flowchart LR
  CURRENT["RISK-PUMP-038<br/>Delayed detection or secondary harm from microbial contamination"]
  PREV0["DEVC-PUMP-005<br/>Infpump FlowGuard critical-care configuration 1.1"]
  PREV0 -->|"has_risk"| CURRENT
  PREV1["RCM-PUMP-038<br/>Thermal shutdown"]
