---
{
  "id": "RISK-PUMP-040",
  "type": "risk",
  "title": "Delayed detection or secondary harm from use error during setup",
  "aliases": [
    "RISK-PUMP-040",
    "RISK-PUMP-040-delayed-detection-or-secondary-harm-from-use-error-during-setup",
    "18-ontology-notes/risk/RISK-PUMP-040-delayed-detection-or-secondary-harm-from-use-error-during-setup",
    "03-Ontology notes/risk/RISK-PUMP-040-delayed-detection-or-secondary-harm-from-use-error-during-setup"
  ],
  "status": "accepted",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "RISK-PUMP-040",
  ...
  "risk_matrix_identifier": "RISK-PUMP-040",
  "initial_risk": "high",
  "residual_risk": "low",
  "concerns": [
...
# Delayed detection or secondary harm from use error during setup
...
- **type:** `risk`
- **title:** `Delayed detection or secondary harm from use error during setup`
- **aliases:** `RISK-PUMP-040`, `RISK-PUMP-040-delayed-detection-or-secondary-harm-from-use-error-during-setup`, `18-ontology-notes/risk/RISK-PUMP-040-delayed-detection-or-secondary-harm-from-use-error-during-setup`, `03-Ontology notes/risk/RISK-PUMP-040-delayed-detection-or-secondary-harm-from-use-error-during-setup`
- **status:** `accepted`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
```mermaid
flowchart LR
  CURRENT["RISK-PUMP-040<br/>Delayed detection or secondary harm from use error during setup"]
  PREV0["DEVC-PUMP-005<br/>Infpump FlowGuard critical-care configuration 1.1"]
  PREV0 -->|"has_risk"| CURRENT
  PREV1["RCM-PUMP-040<br/>Redundant therapy record storage"]
