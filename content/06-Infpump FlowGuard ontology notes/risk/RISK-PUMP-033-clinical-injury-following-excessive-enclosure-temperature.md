---
{
  "id": "RISK-PUMP-033",
  "type": "risk",
  "title": "Clinical injury following excessive enclosure temperature",
  "aliases": [
    "RISK-PUMP-033",
    "RISK-PUMP-033-clinical-injury-following-excessive-enclosure-temperature",
    "18-ontology-notes/risk/RISK-PUMP-033-clinical-injury-following-excessive-enclosure-temperature",
    "03-Ontology notes/risk/RISK-PUMP-033-clinical-injury-following-excessive-enclosure-temperature"
  ],
  "status": "accepted",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "RISK-PUMP-033",
  ...
  "risk_matrix_identifier": "RISK-PUMP-033",
  "initial_risk": "medium",
  "residual_risk": "low",
  "concerns": [
...
# Clinical injury following excessive enclosure temperature
...
- **type:** `risk`
- **title:** `Clinical injury following excessive enclosure temperature`
- **aliases:** `RISK-PUMP-033`, `RISK-PUMP-033-clinical-injury-following-excessive-enclosure-temperature`, `18-ontology-notes/risk/RISK-PUMP-033-clinical-injury-following-excessive-enclosure-temperature`, `03-Ontology notes/risk/RISK-PUMP-033-clinical-injury-following-excessive-enclosure-temperature`
- **status:** `accepted`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
```mermaid
flowchart LR
  CURRENT["RISK-PUMP-033<br/>Clinical injury following excessive enclosure temperature"]
  PREV0["DEVC-PUMP-005<br/>Infpump FlowGuard critical-care configuration 1.1"]
  PREV0 -->|"has_risk"| CURRENT
  PREV1["RCM-PUMP-033<br/>Locking pole clamp"]
