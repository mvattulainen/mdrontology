...
flowchart LR
  ...
  PREV3["RISK-PUMP-018<br/>Delayed detection or secondary harm from software dose-calculation error"]
  PREV3 -->|"concerns"| CURRENT
  PREV4["RISK-PUMP-023<br/>Clinical injury following cybersecurity compromise"]
  PREV4 -->|"concerns"| CURRENT
  PREV_MORE["25 more previous dependencies"]
