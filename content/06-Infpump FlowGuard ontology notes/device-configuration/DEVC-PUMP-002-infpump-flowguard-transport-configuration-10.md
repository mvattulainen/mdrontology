...
flowchart LR
  ...
  PREV2["RISK-PUMP-007<br/>Clinical injury following air introduced into infusion line"]
  PREV2 -->|"concerns"| CURRENT
  PREV3["RISK-PUMP-012<br/>Delayed detection or secondary harm from incorrect drug or concentration selection"]
  PREV3 -->|"concerns"| CURRENT
  PREV4["RISK-PUMP-017<br/>Clinical injury following software dose-calculation error"]
