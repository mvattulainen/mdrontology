...
```mermaid
flowchart LR
  CURRENT["DEVC-PUMP-004<br/>Infpump FlowGuard oncology configuration 1.1"]
  PREV0["CLD-PUMP-004<br/>Oncology configuration classification decision"]
  PREV0 -->|"concerns"| CURRENT
  PREV1["RISK-PUMP-004<br/>Delayed detection or secondary harm from insufficient delivered flow"]
  PREV1 -->|"concerns"| CURRENT
  PREV2["RISK-PUMP-009<br/>Clinical injury following uncontrolled free flow"]
  PREV2 -->|"concerns"| CURRENT
  PREV3["RISK-PUMP-014<br/>Delayed detection or secondary harm from premature battery depletion"]
  PREV3 -->|"concerns"| CURRENT
  PREV4["RISK-PUMP-019<br/>Clinical injury following suppressed or missed alarm"]
  PREV4 -->|"concerns"| CURRENT
  PREV_MORE["26 more previous dependencies"]
  PREV_MORE -->|"additional typed links"| CURRENT
  NEXT0["IP-PUMP-004<br/>Controlled infusion of oncology medicines"]
  CURRENT -->|"has_intended_purpose"| NEXT0
  NEXT1["CLD-PUMP-004<br/>Oncology configuration classification decision"]
  CURRENT -->|"classified_by"| NEXT1
  NEXT2["CRI-PUMP-031<br/>Software requirements traceability"]
  CURRENT -->|"has_applicable_requirement"| NEXT2
  NEXT3["CRI-PUMP-032<br/>Software verification"]
  CURRENT -->|"has_applicable_requirement"| NEXT3
  NEXT4["CRI-PUMP-033<br/>Cybersecurity risk control"]
