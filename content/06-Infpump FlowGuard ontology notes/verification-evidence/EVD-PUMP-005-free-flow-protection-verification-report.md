...
Previous dependencies are ontology notes that lead into this record. They reach it through `supported_by` from [[06-Infpump FlowGuard ontology notes/classification-decision/CLD-PUMP-005-critical-care-configuration-classification-decision|CLD-PUMP-005 — Critical-care configuration classification decision]]; `satisfied_by` from [[06-Infpump FlowGuard ontology notes/compliance-requirement-instance/CRI-PUMP-005-use-error-reduction|CRI-PUMP-005 — Use-error reduction]], [[06-Infpump FlowGuard ontology notes/compliance-requirement-instance/CRI-PUMP-035-security-logging|CRI-PUMP-035 — Security logging]]; `verified_by` from [[06-Infpump FlowGuard ontology notes/risk-control-measure/RCM-PUMP-035-keyed-tubing-connector|RCM-PUMP-035 — Keyed tubing connector]]; `impacts` from [[06-Infpump FlowGuard ontology notes/change/CHG-PUMP-005-alarm-speaker-supplier-change|CHG-PUMP-005 — Alarm speaker supplier change]]; `includes` from [[06-Infpump FlowGuard ontology notes/technical-documentation-set/TD-PUMP-001-infpump-flowguard-mdr-technical-documentation-set|TD-PUMP-001 — Infpump FlowGuard MDR technical documentation set]]. These incoming links show which product, decision, process or evidence records depend on the current note.
...
flowchart LR
  ...
  PREV3["RCM-PUMP-035<br/>Keyed tubing connector"]
  PREV3 -->|"verified_by"| CURRENT
  PREV4["CHG-PUMP-005<br/>Alarm speaker supplier change"]
