---
{
  ...
  "title": "Communication-loss safe-state test report",
  "aliases": [
    "EVD-PUMP-025",
    "EVD-PUMP-025-communication-loss-safe-state-test-report",
    "18-ontology-notes/verification-evidence/EVD-PUMP-025-communication-loss-safe-state-test-report",
    "03-Ontology notes/verification-evidence/EVD-PUMP-025-communication-loss-safe-state-test-report"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "EVD-PUMP-025",
  ...
  "evidence_scope": "Communication-loss safe-state test report",
...
# Communication-loss safe-state test report
...
- **type:** `verification-evidence`
- **title:** `Communication-loss safe-state test report`
- **aliases:** `EVD-PUMP-025`, `EVD-PUMP-025-communication-loss-safe-state-test-report`, `18-ontology-notes/verification-evidence/EVD-PUMP-025-communication-loss-safe-state-test-report`, `03-Ontology notes/verification-evidence/EVD-PUMP-025-communication-loss-safe-state-test-report`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
Previous dependencies are ontology notes that lead into this record. They reach it through `satisfied_by` from [[06-Infpump FlowGuard ontology notes/compliance-requirement-instance/CRI-PUMP-025-protective-earth-and-isolation|CRI-PUMP-025 — Protective earth and isolation]]; `verified_by` from [[06-Infpump FlowGuard ontology notes/risk-control-measure/RCM-PUMP-025-role-based-access-control|RCM-PUMP-025 — Role-based access control]]. These incoming links show which product, decision, process or evidence records depend on the current note.
...
```mermaid
flowchart LR
  CURRENT["EVD-PUMP-025<br/>Communication-loss safe-state test report"]
  PREV0["CRI-PUMP-025<br/>Protective earth and isolation"]
