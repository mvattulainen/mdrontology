---
{
  "id": "CLM-PUMP-006",
  "type": "clinical-claim",
  "title": "Detects clinically relevant air in line",
  "aliases": [
    "CLM-PUMP-006",
    "CLM-PUMP-006-detects-clinically-relevant-air-in-line",
    "18-ontology-notes/clinical-claim/CLM-PUMP-006-detects-clinically-relevant-air-in-line",
    "03-Ontology notes/clinical-claim/CLM-PUMP-006-detects-clinically-relevant-air-in-line"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "CLM-PUMP-006",
...
# Detects clinically relevant air in line
...
- **type:** `clinical-claim`
- **title:** `Detects clinically relevant air in line`
- **aliases:** `CLM-PUMP-006`, `CLM-PUMP-006-detects-clinically-relevant-air-in-line`, `18-ontology-notes/clinical-claim/CLM-PUMP-006-detects-clinically-relevant-air-in-line`, `03-Ontology notes/clinical-claim/CLM-PUMP-006-detects-clinically-relevant-air-in-line`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
```mermaid
flowchart LR
  CURRENT["CLM-PUMP-006<br/>Detects clinically relevant air in line"]
