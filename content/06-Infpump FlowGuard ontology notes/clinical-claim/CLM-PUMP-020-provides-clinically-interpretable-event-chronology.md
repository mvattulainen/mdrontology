---
{
  "id": "CLM-PUMP-020",
  "type": "clinical-claim",
  "title": "Provides clinically interpretable event chronology",
  "aliases": [
    "CLM-PUMP-020",
    "CLM-PUMP-020-provides-clinically-interpretable-event-chronology",
    "18-ontology-notes/clinical-claim/CLM-PUMP-020-provides-clinically-interpretable-event-chronology",
    "03-Ontology notes/clinical-claim/CLM-PUMP-020-provides-clinically-interpretable-event-chronology"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "CLM-PUMP-020",
...
# Provides clinically interpretable event chronology
...
- **type:** `clinical-claim`
- **title:** `Provides clinically interpretable event chronology`
- **aliases:** `CLM-PUMP-020`, `CLM-PUMP-020-provides-clinically-interpretable-event-chronology`, `18-ontology-notes/clinical-claim/CLM-PUMP-020-provides-clinically-interpretable-event-chronology`, `03-Ontology notes/clinical-claim/CLM-PUMP-020-provides-clinically-interpretable-event-chronology`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
```mermaid
flowchart LR
  CURRENT["CLM-PUMP-020<br/>Provides clinically interpretable event chronology"]
