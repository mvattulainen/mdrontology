---
{
  "id": "CLM-PUMP-010",
  "type": "clinical-claim",
  "title": "Supports oncology infusion protocols",
  "aliases": [
    "CLM-PUMP-010",
    "CLM-PUMP-010-supports-oncology-infusion-protocols",
    "18-ontology-notes/clinical-claim/CLM-PUMP-010-supports-oncology-infusion-protocols",
    "03-Ontology notes/clinical-claim/CLM-PUMP-010-supports-oncology-infusion-protocols"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "CLM-PUMP-010",
...
# Supports oncology infusion protocols
...
- **type:** `clinical-claim`
- **title:** `Supports oncology infusion protocols`
- **aliases:** `CLM-PUMP-010`, `CLM-PUMP-010-supports-oncology-infusion-protocols`, `18-ontology-notes/clinical-claim/CLM-PUMP-010-supports-oncology-infusion-protocols`, `03-Ontology notes/clinical-claim/CLM-PUMP-010-supports-oncology-infusion-protocols`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
```mermaid
flowchart LR
  CURRENT["CLM-PUMP-010<br/>Supports oncology infusion protocols"]
