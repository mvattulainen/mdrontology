---
{
  "id": "CLM-PUMP-004",
  "type": "clinical-claim",
  "title": "Reduces unintended free-flow exposure",
  "aliases": [
    "CLM-PUMP-004",
    "CLM-PUMP-004-reduces-unintended-free-flow-exposure",
    "18-ontology-notes/clinical-claim/CLM-PUMP-004-reduces-unintended-free-flow-exposure",
    "03-Ontology notes/clinical-claim/CLM-PUMP-004-reduces-unintended-free-flow-exposure"
  ],
  "status": "approved",
  "version": "1",
  "created": "2026-08-15",
  ...
  "technical_file_identifier": "CLM-PUMP-004",
...
# Reduces unintended free-flow exposure
...
- **type:** `clinical-claim`
- **title:** `Reduces unintended free-flow exposure`
- **aliases:** `CLM-PUMP-004`, `CLM-PUMP-004-reduces-unintended-free-flow-exposure`, `18-ontology-notes/clinical-claim/CLM-PUMP-004-reduces-unintended-free-flow-exposure`, `03-Ontology notes/clinical-claim/CLM-PUMP-004-reduces-unintended-free-flow-exposure`
- **status:** `approved`
- **version:** `1`
- **created:** `2026-08-15`
- **modified:** `2026-08-15`
...
```mermaid
flowchart LR
  CURRENT["CLM-PUMP-004<br/>Reduces unintended free-flow exposure"]
