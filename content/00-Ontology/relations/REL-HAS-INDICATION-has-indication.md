---
{
  "id": "REL-HAS-INDICATION",
  "type": "relation-definition",
  "title": "has_indication",
  "aliases": [
    "REL-HAS-INDICATION",
    "01-ontology/relations/REL-HAS-INDICATION-has-indication"
  ],
  "status": "active",
  "version": "1",
  "created": "2026-08-14",
...
Relates intended-purpose to indication.

## Purpose

Defines the ontology predicate `has_indication`. It constrains which subject and object classes may be connected and gives graph edges a stable, machine-checkable meaning.
