---
{
  "id": "REL-REQUIRES-ACTIVITY",
  "type": "relation-definition",
  "title": "requires_activity",
  "aliases": [
    "REL-REQUIRES-ACTIVITY",
    "01-ontology/relations/REL-REQUIRES-ACTIVITY-requires-activity"
  ],
  "status": "active",
  "version": "1",
  "created": "2026-08-14",
  ...
  "draft": false,
  "predicate": "requires_activity",
  "label": "requires activity",
  "domain": [
...
Relates compliance-requirement-instance to activity.

## Purpose

Defines the ontology predicate `requires_activity`. It constrains which subject and object classes may be connected and gives graph edges a stable, machine-checkable meaning.
