---
{
  ...
  "aliases": [
    "REL-UPDATES",
    "01-ontology/relations/REL-UPDATES-updates"
  ],
  "status": "active",
  "version": "1",
  "created": "2026-08-14",
...
Relates pms-finding to risk-management, clinical-evaluation, technical-documentation.

## Purpose

Defines the ontology predicate `updates`. It constrains which subject and object classes may be connected and gives graph edges a stable, machine-checkable meaning.
...
|---|---|
| Domain | `pms-finding` |
| Range | `risk-management`, `clinical-evaluation`, `technical-documentation` |
| Functional | `false` |
| Transitive | `false` |
