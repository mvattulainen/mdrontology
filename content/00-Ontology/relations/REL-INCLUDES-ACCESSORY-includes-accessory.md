---
{
  "id": "REL-INCLUDES-ACCESSORY",
  "type": "relation-definition",
  "title": "includes_accessory",
  "aliases": [
    "REL-INCLUDES-ACCESSORY",
    "01-ontology/relations/REL-INCLUDES-ACCESSORY-includes-accessory"
  ],
  "status": "active",
  "version": "1",
  "created": "2026-08-14",
...
accessory is included/claimed

## Purpose

Defines the ontology predicate `includes_accessory`. It constrains which subject and object classes may be connected and gives graph edges a stable, machine-checkable meaning.
