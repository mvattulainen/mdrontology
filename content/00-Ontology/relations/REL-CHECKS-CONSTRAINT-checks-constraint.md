---
{
  "id": "REL-CHECKS-CONSTRAINT",
  "type": "relation-definition",
  "title": "checks_constraint",
  "aliases": [
    "REL-CHECKS-CONSTRAINT",
    "01-ontology/relations/REL-CHECKS-CONSTRAINT-checks-constraint"
  ],
  "status": "active",
  "version": "1",
  "created": "2026-08-14",
  ...
  "draft": false,
  "predicate": "checks_constraint",
  "label": "checks constraint",
  "domain": [
    "competency-question"
  ],
  "range": [
...
Defines the ontology predicate `checks_constraint`. It constrains which subject and object classes may be connected and gives graph edges a stable, machine-checkable meaning.
