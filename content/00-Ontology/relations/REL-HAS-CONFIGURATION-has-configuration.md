---
{
  "id": "REL-HAS-CONFIGURATION",
  "type": "relation-definition",
  "title": "has_configuration",
  "aliases": [
    "REL-HAS-CONFIGURATION",
    "01-ontology/relations/REL-HAS-CONFIGURATION-has-configuration"
  ],
  "status": "active",
  "version": "1",
  "created": "2026-08-14",
...
variant has controlled configuration

## Purpose

Defines the ontology predicate `has_configuration`. It constrains which subject and object classes may be connected and gives graph edges a stable, machine-checkable meaning.

## Relation contract

| Property | Value |
|---|---|
| Domain | `device-variant` |
