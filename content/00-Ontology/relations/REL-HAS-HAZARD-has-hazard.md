---
{
  ...
  "aliases": [
    "REL-HAS-HAZARD",
    "01-ontology/relations/REL-HAS-HAZARD-has-hazard"
  ],
  "status": "active",
  "version": "1",
  "created": "2026-08-14",
...
Relates device-configuration to hazard.

## Purpose

Defines the ontology predicate `has_hazard`. It constrains which subject and object classes may be connected and gives graph edges a stable, machine-checkable meaning.
