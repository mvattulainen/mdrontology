---
{
  "id": "REL-INTERPRETED-BY",
  "type": "relation-definition",
  "title": "interpreted_by",
  "aliases": [
    "REL-INTERPRETED-BY",
    "01-ontology/relations/REL-INTERPRETED-BY-interpreted-by"
  ],
  "status": "active",
  "version": "1",
  "created": "2026-08-14",
...
Relates legal-provision to guidance.

## Purpose

Defines the ontology predicate `interpreted_by`. It constrains which subject and object classes may be connected and gives graph edges a stable, machine-checkable meaning.

## Relation contract

| Property | Value |
|---|---|
| Domain | `legal-provision` |
| Range | `guidance` |
| Functional | `false` |
| Transitive | `false` |
