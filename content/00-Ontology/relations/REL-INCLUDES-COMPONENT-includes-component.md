---
{
  "id": "REL-INCLUDES-COMPONENT",
  "type": "relation-definition",
  "title": "includes_component",
  "aliases": [
    "REL-INCLUDES-COMPONENT",
    "01-ontology/relations/REL-INCLUDES-COMPONENT-includes-component"
  ],
  "status": "active",
  "version": "1",
  "created": "2026-08-14",
...
component is part of configuration

## Purpose

Defines the ontology predicate `includes_component`. It constrains which subject and object classes may be connected and gives graph edges a stable, machine-checkable meaning.
