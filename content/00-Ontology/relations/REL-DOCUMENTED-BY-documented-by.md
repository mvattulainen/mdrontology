---
{
  "id": "REL-DOCUMENTED-BY",
  "type": "relation-definition",
  "title": "documented_by",
  "aliases": [
    "REL-DOCUMENTED-BY",
    "01-ontology/relations/REL-DOCUMENTED-BY-documented-by"
  ],
  "status": "active",
  "version": "1",
  "created": "2026-08-14",
...
Relates clinical-evaluation to clinical-evaluation-report.

## Purpose

Defines the ontology predicate `documented_by`. It constrains which subject and object classes may be connected and gives graph edges a stable, machine-checkable meaning.
...
| Range | `clinical-evaluation-report` |
| Functional | `false` |
| Transitive | `false` |
