---
{
  "id": "REL-SUPERSEDED-BY",
  "type": "relation-definition",
  "title": "superseded_by",
  "aliases": [
    "REL-SUPERSEDED-BY",
    "01-ontology/relations/REL-SUPERSEDED-BY-superseded-by"
  ],
  "status": "active",
  "version": "1",
  "created": "2026-08-14",
...
Defines the ontology predicate `superseded_by`. It constrains which subject and object classes may be connected and gives graph edges a stable, machine-checkable meaning.
...
| Range | `document-version`, `evidence-item` |
| Functional | `false` |
| Transitive | `false` |
