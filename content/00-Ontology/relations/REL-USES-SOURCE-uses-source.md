---
{
  ...
  "aliases": [
    "REL-USES-SOURCE",
    "01-ontology/relations/REL-USES-SOURCE-uses-source"
  ],
  "status": "active",
  "version": "1",
  "created": "2026-08-14",
...
Defines the ontology predicate `uses_source`. It constrains which subject and object classes may be connected and gives graph edges a stable, machine-checkable meaning.
