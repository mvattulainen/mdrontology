---
{
  "id": "REL-DERIVED-BY-RULE",
  "type": "relation-definition",
  "title": "derived_by_rule",
  "aliases": [
    "REL-DERIVED-BY-RULE",
    "01-ontology/relations/REL-DERIVED-BY-RULE-derived-by-rule"
  ],
  "status": "active",
  "version": "1",
  "created": "2026-08-14",
...
Relates assertion to rule.

## Purpose

Defines the ontology predicate `derived_by_rule`. It constrains which subject and object classes may be connected and gives graph edges a stable, machine-checkable meaning.
