---
{
  ...
  "aliases": [
    "REL-UPDATED-BY",
    "01-ontology/relations/REL-UPDATED-BY-updated-by"
  ],
  "status": "active",
  "version": "1",
  "created": "2026-08-14",
...
Relates clinical-evaluation to pms-finding, pmcf-result.

## Purpose

Defines the ontology predicate `updated_by`. It constrains which subject and object classes may be connected and gives graph edges a stable, machine-checkable meaning.
