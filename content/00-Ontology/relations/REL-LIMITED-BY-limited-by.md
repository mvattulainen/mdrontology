---
{
  ...
  "aliases": [
    "REL-LIMITED-BY",
    "01-ontology/relations/REL-LIMITED-BY-limited-by"
  ],
  "status": "active",
  "version": "1",
  "created": "2026-08-14",
...
Relates intended-purpose, claim to use-limitation.

## Purpose

Defines the ontology predicate `limited_by`. It constrains which subject and object classes may be connected and gives graph edges a stable, machine-checkable meaning.
