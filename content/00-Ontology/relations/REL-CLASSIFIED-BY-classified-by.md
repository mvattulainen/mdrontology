---
{
  "id": "REL-CLASSIFIED-BY",
  "type": "relation-definition",
  "title": "classified_by",
  "aliases": [
    "REL-CLASSIFIED-BY",
    "01-ontology/relations/REL-CLASSIFIED-BY-classified-by"
  ],
  "status": "active",
  "version": "1",
  "created": "2026-08-14",
...
Relates device-configuration to classification-decision.

## Purpose

Defines the ontology predicate `classified_by`. It constrains which subject and object classes may be connected and gives graph edges a stable, machine-checkable meaning.
