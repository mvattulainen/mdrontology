---
{
  ...
  "aliases": [
    "REL-SUPPORTED-BY",
    "01-ontology/relations/REL-SUPPORTED-BY-supported-by"
  ],
  "status": "active",
  "version": "1",
  "created": "2026-08-14",
...
Relates assertion, decision to evidence-item.

## Purpose

Defines the ontology predicate `supported_by`. It constrains which subject and object classes may be connected and gives graph edges a stable, machine-checkable meaning.

## Relation contract

| Property | Value |
|---|---|
| Domain | `assertion`, `decision` |
| Range | `evidence-item` |
| Functional | `false` |
| Transitive | `false` |
