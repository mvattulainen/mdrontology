---
{
  "id": "REL-HAS-IMPACT-ASSESSMENT",
  "type": "relation-definition",
  "title": "has_impact_assessment",
  "aliases": [
    "REL-HAS-IMPACT-ASSESSMENT",
    "01-ontology/relations/REL-HAS-IMPACT-ASSESSMENT-has-impact-assessment"
  ],
  "status": "active",
  "version": "1",
  "created": "2026-08-14",
  ...
  "draft": false,
  "predicate": "has_impact_assessment",
...
Defines the ontology predicate `has_impact_assessment`. It constrains which subject and object classes may be connected and gives graph edges a stable, machine-checkable meaning.
...
|---|---|
| Domain | `change` |
| Range | `change-impact-assessment` |
| Functional | `false` |
| Transitive | `false` |
