---
{
  "id": "REL-HAS-INTENDED-PURPOSE",
  "type": "relation-definition",
  "title": "has_intended_purpose",
  "aliases": [
    "REL-HAS-INTENDED-PURPOSE",
    "01-ontology/relations/REL-HAS-INTENDED-PURPOSE-has-intended-purpose"
  ],
  "status": "active",
  "version": "1",
  "created": "2026-08-14",
...
Relates device, configuration to intended-purpose.

## Purpose

Defines the ontology predicate `has_intended_purpose`. It constrains which subject and object classes may be connected and gives graph edges a stable, machine-checkable meaning.
