---
{
  "id": "REL-USES-EVIDENCE",
  "type": "relation-definition",
  "title": "uses_evidence",
  "aliases": [
    "REL-USES-EVIDENCE",
    "01-ontology/relations/REL-USES-EVIDENCE-uses-evidence"
  ],
  "status": "active",
  "version": "1",
  "created": "2026-08-14",
...
Relates clinical-evaluation to clinical-evidence.

## Purpose

Defines the ontology predicate `uses_evidence`. It constrains which subject and object classes may be connected and gives graph edges a stable, machine-checkable meaning.
