---
{
  "id": "REL-HAS-CONTRAINDICATION",
  "type": "relation-definition",
  "title": "has_contraindication",
  "aliases": [
    "REL-HAS-CONTRAINDICATION",
    "01-ontology/relations/REL-HAS-CONTRAINDICATION-has-contraindication"
  ],
  "status": "active",
  "version": "1",
  "created": "2026-08-14",
...
Relates intended-purpose to contraindication.

## Purpose

Defines the ontology predicate `has_contraindication`. It constrains which subject and object classes may be connected and gives graph edges a stable, machine-checkable meaning.
