---
{
  ...
  "aliases": [
    "REL-PART-OF",
    "01-ontology/relations/REL-PART-OF-part-of"
  ],
  "status": "active",
  "version": "1",
  "created": "2026-08-14",
...
Defines the ontology predicate `part_of`. It constrains which subject and object classes may be connected and gives graph edges a stable, machine-checkable meaning.

## Relation contract

| Property | Value |
|---|---|
| Domain | `source-fragment` |
| Range | `source` |
| Functional | `false` |
| Transitive | `false` |
