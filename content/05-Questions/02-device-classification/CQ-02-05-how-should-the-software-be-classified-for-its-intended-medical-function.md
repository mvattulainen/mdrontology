---
{
  ...
  "title": "How should the software be classified for its intended medical function?",
  "aliases": [
    "CQ-02-05",
    "15-questions/02-device-classification/CQ-02-05-how-should-the-software-be-classified-for-its-intended-medical-function"
  ],
  "status": "active",
  "version": "1",
  "created": "2026-08-14",
  ...
  "ontology_path": "SoftwareVersion → MedicalFunction → InformationUse/DecisionImpact → SoftwareClassificationRule → ClassificationDecision",
...
# How should the software be classified for its intended medical function?
...
`SoftwareVersion → MedicalFunction → InformationUse/DecisionImpact → SoftwareClassificationRule → ClassificationDecision`


## Answer

Software classification follows the intended medical function and the significance of the information or action it provides, including its impact on diagnostic or therapeutic decisions and the possible harm from an incorrect result. The ontology evaluates the released software version through medical function, information use and decision impact, applies the software classification rule, and records a configuration-specific classification decision.
